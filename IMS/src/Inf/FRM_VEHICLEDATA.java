...
public class FRM_VEHICLEDATA extends javax.swing.JFrame {

    Connection conn = null;
    PreparedStatement pst = null;
    ResultSet rs = null;

    public FRM_VEHICLEDATA() {
        initComponents();
    ...
    public FRM_VEHICLEDATA(String para) {
                ...
                if (rs.getString("level").equals("admin")) {
                 ...
                 //   btn_Add.setEnabled(true);
                   ...
                   // btn_Delete.setEnabled(true);
                    ...
                    txt_Chas_number.setEditable(true);
                    txt_Engi_number.setEditable(true);
                    txt_Brand.setEditable(true);
                    txt_Model.setEditable(true);
                    txt_FirstRegDate.setEditable(true);
                    cb_Vtype.setEditable(true);
                    cb_Usage.setEditable(true);
                    txt_Cons_Year.setEditable(true);
                    txt_Engcapacity.setEditable(true);
                    cb_Fueltype.setEditable(true);
                    cb_Bodytype.setEditable(true);
                  ...
                  //  btn_Delete.setEnabled(false);
                    ...
                    txt_Chas_number.setEditable(false);
                    txt_Engi_number.setEditable(false);
                    txt_Brand.setEditable(false);
                    txt_Model.setEditable(false);
                    txt_FirstRegDate.setEditable(false);
                    cb_Vtype.setEditable(false);
                    cb_Usage.setEditable(false);
                    txt_Cons_Year.setEditable(false);
                    txt_Engcapacity.setEditable(false);
                    cb_Fueltype.setEditable(false);
                    cb_Bodytype.setEditable(false);
    ...
    private void btn_UpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_UpdateActionPerformed
        ...
        try {
            ...
            String sql = "UPDATE vehicle_data SET Vehicle_number='" + Vehi_number + "',Chas_number='" + Chas_number + "',Eng_number='" + Eng_number + "',Brand='" + Brand + "',Model='" + Model + "',First_Reg_date='" + First_Reg_Date + "',Vehilce_type='" + Vehi_type + "',Vehi_usage='" + Vehi_usage + "',Cons_year='" + Cons_year + "',Engiine_capacity='" + Eng_capacity + "',Fuel_type='" + Fuel_type + "',Body_type='" + Body_type + "' WHERE Vehicle_number= '" + Vehi_number + "'";
            pst = conn.prepareStatement(sql);
            pst.execute();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FRM_VEHICLEDATA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FRM_VEHICLEDATA().setVisible(true);
            }
        });
    }
