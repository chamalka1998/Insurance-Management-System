...
public class FRM_CUSTDATA_new extends javax.swing.JFrame {

    Connection conn = null;
    PreparedStatement pst = null;
    ResultSet rs = null;

    public FRM_CUSTDATA_new() {
        initComponents();
    ...
    public FRM_CUSTDATA_new(String para) {
...
//        cust_pin = Integer.parseInt(txt_Custpin.getText());
        ...
        try {
            ...
            String sql = "INSERT INTO customer_data(fname,lname,address,contact_number,name_with_ini,full_name,comments,saluation,occupation, nic_number)VALUES('" + fname + "','" + lname + "','" + address + "','" + contact_number + "','" + name_with_ini + "','" + full_name + "','" + comments + "','" + saluation + "','" + occupation + "','" + nic_number + "')";
        ...
        FRM_VEHICLEDATA_new v=new FRM_VEHICLEDATA_new();
        v.setVisible(true);       
        dispose();
...
//        if (check == 0) {
//
//            String cust_pin = txt_Custpin.getText();
//
//            try {
//
//                String sql = "DELETE FROM customer_data WHERE cust_pin='" + cust_pin + "'";
//                pst = conn.prepareStatement(sql);
//                pst.execute();
...
//    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FRM_CUSTDATA_new.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FRM_CUSTDATA_new().setVisible(true);
            }
        });
    }
